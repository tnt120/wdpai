...
<head>
    ...
    <title>My books - currently reading</title>
</head>
    ...
    <main>
        <div class="main-my-books-title-wrapper">
            ...
            <ul class="main-my-books-title-wrapper-nav">
                ...
                <li>
                    <a href="" class="main-my-books-title-warpper-main-option selected">Currently reading</a>
                </li>
                <li>
            ...
            <?php foreach ($books as $book): ?>
                <div class="content-item">
                    ...
                    <div class="buttons">
                        ...
                        <button class="button to-read" onclick="updateUserBook(3, <?= $book->getBookId() ?>)"><img src="
                            /public/img/to-read.svg" alt="to-read"></button>
